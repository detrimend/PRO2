...
public class MyDate
{
    ...
    * negative year is set to its positive counterpart, a month less than 1 is
    * set to 1 and more than 12 is set to 12. A day less than 1 is set to 1 and
    * a day more than the last day of the specified month is set to this last
    * day
    * 
    * @param day
    *           the day
   ...
   /**
    * Setting the date. Illegal dates are converted to legal dates; a negative
    * year is set to its positive counterpart, a month less than 1 is set to 1
    * and more than 12 is set to 12. A day less than 1 is set to 1 and a day
    ...
    * @param other
    *           the other date
    * @return the number of days between this date and the date given as
    *         argument
    */
    ...
    * @return true if the object <code>obj</code> is a MyDate object with the
    *         same day, month and year as this date.
    ...
    * 
    * @param monthName
    *           the month as one of the following strings: {"January",
    *           "February", "March", "April", "May", "June", "July", "August",
    *           "September", "October", "November", "December"}.
    * @return the month as an integer in the range 1-12. For illegal month
