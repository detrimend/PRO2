...
class ClockTest_Blackbox
{
  ...
  @Test void constructor3Boundary()
  {
    ...
    // lower right boundary: 0 [already done in constructor1Zero()]
    ...
    assertThrows(java.lang.IllegalArgumentException.class, () -> {
      clock = new Clock(0, 0, 60);
    });
    assertThrows(java.lang.IllegalArgumentException.class, () -> {
      clock = new Clock(0, 60, 0);
    });
    assertThrows(java.lang.IllegalArgumentException.class, () -> {
      clock = new Clock(24, 0, 0);
    });
  }
  ...
  @Test void constructor3Exception()
  {
    ...
    assertThrows(java.lang.IllegalArgumentException.class, () -> {
      clock = new Clock(-5, 0, 0);
    });

    // values > 23 for hour and > 59 for seconds and minutes
    assertThrows(java.lang.IllegalArgumentException.class, () -> {
      clock = new Clock(0, 0, 71);
    });
    assertThrows(java.lang.IllegalArgumentException.class, () -> {
      clock = new Clock(0, 71, 0);
    });
    assertThrows(java.lang.IllegalArgumentException.class, () -> {
      clock = new Clock(41, 0, 0);
    });
  }

  @Test void constructor1ArgsZero()
  {
    clock = new Clock(0);
    assertEquals("0:0:0", valueOf(clock));
  }
  ...
  @Test void constructor1ArgsMany()
  {
    clock = new Clock(185);
  ...
  {
    // right lower bound: 0 [already done in constructor1ArgsZero()]
  ...
  @Test void constructor1ArgsExceptions()
  {
    assertThrows(java.lang.IllegalArgumentException.class, () -> {
      clock = new Clock(-26);
    });
    assertThrows(java.lang.IllegalArgumentException.class, () -> {
      clock = new Clock(-90000);
    });
  }
  ...
  @Test void setBoundary()
  {
    ...
    // lower right boundary: 0 [already done in setZero()]
  ...
  @Test void getTimeInSecondsExceptions()
  {
